...
# CORS untuk frontend (lokal atau docker)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # izinkan semua origin untuk demo
    allow_credentials=True,
    allow_methods=["*"],
    allow_headers=["*"],
)

# Ambil ENV VAR dengan default fallback
...
async def create_order(request: Request):
    ...
    # Ambil data dari body atau pakai dummy
